...
//punho branca
  ...
  btncorvistaDpreto.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#fce9c9";
    document.getElementById('VD').style.backgroundColor = "#fce9c9";
  });
  //vistaD azul
  const btncorvistaDazul = document.getElementById('bluebase6');
  btncorvistaDazul.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#b5a397";
    document.getElementById('VD').style.backgroundColor = "#b5a397";
  });    
  //vistaD vermelha
  const btncorvistaDvermelha = document.getElementById('redbase6');
  btncorvistaDvermelha.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#ffd3cf";
    document.getElementById('VD').style.backgroundColor = "#ffd3cf";
  });  
  //vistaD amarela
  const btncorvistaDamarela = document.getElementById('yellowbase6');
  btncorvistaDamarela.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#ad6681";
    document.getElementById('VD').style.backgroundColor = "#ad6681";
  });  
  //vistaD verde
  const btncorvistaDverde = document.getElementById('greenbase6');
  btncorvistaDverde.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#88759d";
    document.getElementById('VD').style.backgroundColor = "#88759d";
  });
  ...
  btncorbolsoFpreto.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#fce9c9";
    document.getElementById('BSF').style.backgroundColor = "#fce9c9";
  });
  //Bolso Faixa azul
  const btncorbolsoFazul = document.getElementById('bluebase7');
  btncorbolsoFazul.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#b5a397";
    document.getElementById('BSF').style.backgroundColor = "#b5a397";
  });    
  ...
  btncorbolsoFvermelha.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#ffd3cf";
    document.getElementById('BSF').style.backgroundColor = "#ffd3cf";
  });  
  //Bolso Faixa amarela
  const btncorbolsoFamarela = document.getElementById('yellowbase7');
  btncorbolsoFamarela.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#ad6681";
    document.getElementById('BSF').style.backgroundColor = "#ad6681";
  });  
  //Bolso Faixa verde
  const btncorbolsoFverde = document.getElementById('greenbase7');
  btncorbolsoFverde.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#88759d";
    document.getElementById('BSF').style.backgroundColor = "#88759d";
  });
  ...
  btncorbolsoBpreto.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#fce9c9";
    document.getElementById('BB').style.backgroundColor = "#fce9c9";
  });
  //Bolso Faixa azul
  const btncorbolsoBazul = document.getElementById('bluebase8');
  btncorbolsoBazul.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#b5a397";
    document.getElementById('BB').style.backgroundColor = "#b5a397";
  });    
  //Bolso Faixa vermelha
  const btncorbolsoBvermelha = document.getElementById('redbase8');
  btncorbolsoBvermelha.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#ffd3cf";
    document.getElementById('BB').style.backgroundColor = "#ffd3cf";
  });  
  //Bolso Faixa amarela
  const btncorbolsoBamarela = document.getElementById('yellowbase8');
  btncorbolsoBamarela.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#ad6681";
    document.getElementById('BB').style.backgroundColor = "#ad6681";
  });  
  //Bolso Faixa verde
  const btncorbolsoBverde = document.getElementById('greenbase8');
  btncorbolsoBverde.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#88759d";
    document.getElementById('BB').style.backgroundColor = "#88759d";
  });
